describe("Basic user flow for SPA ", () => {
  ...
  it("Test20: On second Entry page - checking <entry-page> contents", async () => {
    ...
    if (
      img.src !=
      "https://advancelocal-adapter-image-uploads.s3.amazonaws.com/image.syracuse.com/home/syr-media/width2048/img/entertainment_impact/photo/shrek-donkeyjpg-daa31aa2b5bedfaa.jpg"
    ) {
      check = false;
    }
  ...
  //Note: I included more than 20 tests because there are several tests checking the same thing (going back to main page)
  //I checked with Cora and she said it is fine
